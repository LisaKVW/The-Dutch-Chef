      ...
      <div className="grid-wrap" style={{ display: "grid", gridTemplateColumns: "50% 50%", width: "80%", marginTop: "5.3vh", margin: "0 auto", gridColumnGap: "2rem" }}>
        ...
        <section className="contact-email" style={{ marginTop: "32px" }}>
          ...
          <p>
            ...
            Lisa Wand grew up in the Netherlands in a family of chefs and started her steps into the culinary industry at a young age in her family’s restaurant De Lachende  Javaan in Haarlem.
            Her mom thought her most of her cooking skills and her family exposed her to food on daily base, and with that her passion for cooking (and eating) grew. From the Netherlands she started her international career in New York City at the 1 Michelin star Italian restaurant Del Posto. After her 1 year experience of top level culinary interaction her passion for the hospitality and people grew and she worked as a Food and Beverage manager at the Waldorf Astoria and the Peninsula Hotel New York.
            As time passed, Lisa always loved technology and video games and she decided that she wanted to cook for her loved ones and enjoy dinner experiences as a ‘hobby’ and wanted to become a software engineer.
            With these new skills, I am so happy to share that I can now do my two passions at the same time, I can cook for family and friends and code and share my culinary experiences on my own created website ‘the Dutch Chef’.
